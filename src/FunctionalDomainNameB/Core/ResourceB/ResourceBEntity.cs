...
namespace FunctionalDomainNameB.Core.ResourceB;

internal record ResourceBId : EntityId
{
    public ResourceBId(Guid value) : base(value) { }
    public ResourceBId() : base() { }
...
internal class ResourceBEntity : Entity<ResourceBId>
{
    ...
    [JsonConstructor]
    public ResourceBEntity() { SomeProperty = string.Empty; }
    public ResourceBEntity(string someProperty) : base()
    {
